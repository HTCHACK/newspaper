                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    ...
                                    <form method="POST" action="{{ route('galleries.update',$gallery->id) }}" class="form-group"
                                        enctype="multipart/form-data">

                                        @csrf
                                        @method('put')
                                        <div class="form-group">{{ $gallery->name }}
                                            <input type="text" class="form-control"  placeholder="Enter file Name"
                                                name="name">
                                        </div>
                                        <img src="{{ asset('storage/' . $gallery->image) }}" width="100px" height="70px">
